...
Const
  ...
  CT_MagicIdentificator: String = {$IFDEF PRODUCTION}'PascalCoin'{$ELSE}'PascalCoinTESTNET'{$ENDIF}; //
  ...
  CT_ClientAppVersion : String = {$IFDEF PRODUCTION}'4.0.3.1'{$ELSE}{$IFDEF TESTNET}'TESTNET 4.0.3.1'{$ELSE}{$ENDIF}{$ENDIF};
