...
| Algorithm                    | Validation Hashrate (H/s) | Mean Memory per Hash (b) | Min Memory per Hash (b) | Max Memory per Hash (b) | Standard Deviation (b) |
| :--------------------------: | :------------------------ | :----------------------- | :---------------------- | :---------------------- | :--------------------  |
| RandomHash (validation)      | 22.5                      | 5,018,873                | 5,018,596               | 5,019,132               | 90.67                  |
| RandomHash (mining)          |  
| RandomHash2 (validation)     | 343                       | 16,839                   | 1,380                   | 217,296                 | 29,117                 |
| RandomHash2 (mining)         | 1,097                     | 16,629                   | 1,312                   | 225,956                 | 29,086                 |
| RandomHash2 (mining to N=2)  | 266                       | 4,229                    | 1,312                   | 7,216                   | 1,854                  |
| RandomHash2 (mining to N=3)  | 773                       | 6,283                    | 1,312                   | 50,088                  | 6,668                  |



#### RandomHash Nonce Scanning Attack


 is simply hashing blockheaders for verifying blockchain connections. Mining mode is hashing headers, and re-using dependent hsah

For example, a validating nodea validation If an average node is validating blocks at 35 hashes per second, it means just the block header validation alone takes 
